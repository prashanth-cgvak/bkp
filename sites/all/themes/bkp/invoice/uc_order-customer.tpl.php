 ...
 */
?>
<table width="95%" border="0" cellspacing="0" cellpadding="1" align="center" bgcolor="#DFBE5F" style="font-family: verdana, arial, helvetica; font-size: small;">
  <tr>
    <td>
        ...
        <tr valign="top">
          <td>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#DFBE5F" style="color: white;">
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" style="font-family: verdana, arial, helvetica; font-size: small;">
                    <tr>
                      <td valign="top" width="50%">
                        ...
                        <br />
                        <b><?php echo t('Phone Number:'); ?></b><br />
                  ...
                  <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <td>
                        <b><?php echo  $order_payment_method; ?></b>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        ...
                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                          ...
                          <tr>
                            ...
                            <td width="98%">
                              ...
                              <br />
                              <?php echo t('Model Number: ') . $product->model; ?><br />
